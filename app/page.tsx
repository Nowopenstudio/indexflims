...
export default async function Home(props: {
  ...
  const query = await getData(`{
    'data':*[_type=='settings'][0]{reel{"image":image.asset->url, "vid":video.asset->playbackId, "ratio":video.asset->data.aspect_ratio},feat[]->{title,client,abbr,"slug":slug.current,copy,loop{"image":image.asset->url, "vid":video.asset->playbackId, "ratio":video.asset->data.aspect_ratio}},contact,socials }
    }`)
