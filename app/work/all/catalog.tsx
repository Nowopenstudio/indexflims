        ...
        <div className="grid grid-cols-6 w-full items-start">
          ...
          {data?.map((item: any, i: any) => (
            <React.Fragment key={i}>
              <Link href={`/work/${item.slug}`} onMouseEnter={(e) => { Hover(i, e) }} onMouseLeave={(e) => { UnHover(e) }} className="aspect-square relative fadeIn p-4 text-(--black) uppercase pointer-events-auto" style={{ animationDelay: `${i * .00}s` }}>
